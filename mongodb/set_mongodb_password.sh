...
MONGODB_ADMIN_PASS=${MONGODB_ADMIN_PASS:-"0847286333_a"}

# Application Database User
MONGODB_APPLICATION_DATABASE=${MONGODB_APPLICATION_DATABASE:-"tmga"}
MONGODB_APPLICATION_USER=${MONGODB_APPLICATION_USER:-"deathsy"}
MONGODB_APPLICATION_PASS=${MONGODB_APPLICATION_PASS:-"0847286333_a"}
