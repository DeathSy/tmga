...
const GET_ALL_SECTION = defineAction('section/GET_ALL', ['ERROR', 'SUCCESS', 'LOADING'])
const GET_SECTION = defineAction('section/get', ['ERROR', 'SUCCESS', 'LOADING'])
const CREATE_SECTION = defineAction('section/create', ['ERROR', 'SUCCESS', 'LOADING'])
const EDIT_SECTION = defineAction('section/edit', ['ERROR', 'SUCCESS', 'LOADING'])
const DELETE_SECTION = defineAction('section/delete', ['ERROR', 'SUCCESS', 'LOADING'])
...
export const createSection = guideline => {
  return async dispatch => {
    try {
      ...
      const { data } = await axios.post('/sections', guideline)
...
export const editSection = (id, guideline) => {
  return async dispatch => {
    try {
      ...
      const { data } = await axios.put(`/sections/${id}`, guideline)
...
export const deleteSection = id => {
  return async dispatch => {
    try {
      ...
      const { data } = await axios.delete(`/sections/${id}`)
