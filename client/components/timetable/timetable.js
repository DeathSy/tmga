  ...
  <Table basic='very' fixed style={{"width": "750px", "overflow": "scroll", "margin":"50px"}} >
    ...
    <Table.Body>
      <Table.Row>
        ...
        <Table.Cell  style={{"padding-left":"25px"}}> <Icon size='big' color='green' name='checkmark' /></Table.Cell>
      </Table.Row>
      <Table.Row>
        <Table.Cell  style={{"padding-left":"25px"}} >2/2561</Table.Cell>
        <Table.Cell  style={{"padding-left":"25px"}}> <Icon loading size='big' color='red' name='refresh' /></Table.Cell>
      </Table.Row>
    </Table.Body>
  </Table>
)
